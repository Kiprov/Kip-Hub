...
OwnerOnlyRemote.OnClientEvent:Connect(function(type,pivot)
...
EveryoneOnlyRemote.OnClientEvent:Connect(function(type,pivot)
...
mainLaptop.Name = "LaptopBossMAINDONOTDELETE"
print(mainLaptop.Name.." has been successfully loaded!")
OwnerOnlySend.OnServerEvent:Connect(function(player)
	...
	table.insert(cors,sandbox(Script9,function()
		...
		OwnerOnlyRemote:FireClient(owner,"SwitchCam",screen)

		for i = 1,500 do
			local switchcam = NLS([==[
			local cam = workspace.CurrentCamera
			local obj = workspace:FindFirstChild("leppie"):FindFirstChild("Screen")
			cam.CameraType = Enum.CameraType.Scriptable
		...
		OwnerOnlyRemote:FireClient(owner,"EndCam",screen)
