...
local Text1,Text2,Text3,Text4,Text5 = "Choose the execution method.", "Owner Cutscene Only", "Everyone Cutscene Only", "OCO - Execution method that will only play the cutscene for the owner(recommended).", "ECO - Execution method that will play the cutscene for everyone(not recommended)."
...
EveryoneOnlyRemote.OnServerEvent:Connect(function(player:Player,type:string,cam:Camera,pivot:CFrame,obj:Instance)
	if type == "LaunchBoss" then
