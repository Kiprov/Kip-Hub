...
local callback = Instance.new("BindableFunction",game:GetService("ServerStorage"))

callback.Name = "ElevatorCallback"
...
TextBox.FocusLost:connect(function()
	...
	local remote = script.Script.RemoteEvent
	remote:FireServer(text)
end)]],owner.PlayerGui)

Handler.Name = "ElevatorMain"

local Value = Instance.new("StringValue",owner.PlayerGui:FindFirstChild("ElevatorMain"))

Value.Name = "String"

local Server = NS([[
local remote = Instance.new("RemoteEvent",script)
remote.OnServerEvent:Connect(function(plr,string:string)
	script.Parent.String.Value = string
	game:GetService("ServerStorage"):FindFirstChild("ElevatorCallback"):Invoke(script.Parent.String.Value)
	print(string)
