...
local function Main_Dragify_LS()
...
local function Main_LS()
	...
	local ebat = listfiles("KipX\Scripts")
	if #ebat > 0  then
		for i = 1,#ebat do
			canvas = canvas + 0.2
		...
		warn("There is no scripts in your KipX Script Folder!")
	end
end
...
local function LoadCircle_LS()
	local fhjkhdfgjkfdg = game:GetObjects("rbxassetid://6505037974")[1]
	local SpriteClip = require(fhjkhdfgjkfdg)
