...
local function Status_LS()
	while Status:GetAttribute("Flashing") == true do
		game.TweenService:Create(Status,TweenInfo.new(.1,Enum.EasingStyle.Linear,Enum.EasingDirection.Out),{TextColor3 = Color3.new(0.494118, 0.494118, 0.494118)}):Play()
		wait(.1)
		game.TweenService:Create(Status,TweenInfo.new(.1,Enum.EasingStyle.Linear,Enum.EasingDirection.Out),{TextColor3 = Color3.new(1,1,1)}):Play()
		wait(.1)
	end
end
